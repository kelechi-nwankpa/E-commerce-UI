  ...
  return (
    <div className="pt-5">
      ...
      <div className="d-flex flex-column justify-content-center align-items-center pt-3">
        ...
        <p className="col-4" style={{ color: "gray" }}>
          This is a Simple Ecommerce UI, developed with React by Godwin F. in
          fulfillment of the Wella Schools Software Engineering Cohort
        </p>
      </div>
      <div className="d-flex align-items-center justify-content-center gap-2">
        <div className="d-flex align-items-center gap-2">
          <h2 className="fw-bold text-primary">TheFGEEshop</h2>
          <p className="text-gray" style={{ fontSize: "12px", color: "gray" }}>
