...
const Navbar = () => {
  ...
  return (
    <div className="d-flex justify-content-between align-items-center py-3 px-2 sticky-top bg-white">
      <div>
        <Link className="text-decoration-none text-dark fs-1" to="/">
          <HomeIcon />
        </Link>
      </div>
      <div>
      ...
      <div className="position-relative">
        ...
        <span
          className="text-white bg-primary position-absolute d-flex align-items-center justify-content-center"
          style={{
            borderRadius: "50%",
            padding: "2px",
            right: "-5px",
